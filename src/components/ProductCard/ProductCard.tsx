...
const ProductCard = ( props: Props ) =>
{
    return (
        <Box sx={ { border: 2, height: 430, width: '100%', borderRadius: 2 } } >
            <Box sx={ { pt: 1 } }>
                <img height={ 220 } width={ '100%' } src="https://www.crunchlabs.com/cdn/shop/files/Untitleddesign_d57d8055-deff-42bd-8b80-8bb47a91ff6d.png?v=1716312776" />
            </Box>
            <Box sx={ { px: 2 } }>
                <Stack spacing={ 1 }>
                    <Typography variant='subtitle1'>Merchandise</Typography>
                    <Typography variant='h6'>Phat Gus Plush Toy</Typography>
